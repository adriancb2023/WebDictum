...
export default function LoginForm() {
  ...
  return (
    <div className="login-container">
      ...
      <section className="hero hero-scroll-effect">
        <div className="hero-content">
          <div className="hero-text">
            <h1 className="hero-title">
              <span className="title-main">Dictum</span>
            </h1>
            <div className="hero-info">
              <div className="status-row">
                <span className="status-text status-available">Sistema de Gestión Legal</span>
                <span className="platform-item platform-windows">
                  <i className="fas fa-shield-alt"></i> Seguro
                </span>
              </div>
            </div>
            <p className="hero-description">
              Accede a tu cuenta para gestionar casos, clientes y documentos de manera eficiente y segura.
            </p>
          ...
          <div className="hero-visual">
            <div className="app-showcase">
              <img src="/Recursos/Main/mainclaro.png" alt="Dictum App Interface" className="app-screenshot" style={{width: '200%'}} />
            </div>
          </div>
        </div>
      </section>
